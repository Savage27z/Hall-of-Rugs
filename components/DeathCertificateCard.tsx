...
export default function DeathCertificateCard({
  ...
  return (
    <Link href={`/autopsy/${token.address}`}>
      <div
        className="group bg-surface border border-border rounded-[4px] p-5 sm:p-6 relative overflow-hidden transition-shadow duration-200 hover:shadow-[0_0_20px_rgba(220,38,38,0.3)] cursor-pointer opacity-0 animate-fade-up card-noise"
